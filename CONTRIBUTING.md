...
1. **Create a remote to track the base yatishbalaji/moment-working-days repository**
   ...
   (more on that shortly).  You would execute something like:
        ...
        git remote add base git://github.com/yatishbalaji/moment-working-days.git
